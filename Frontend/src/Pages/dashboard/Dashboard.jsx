// pages/dashboard/Dashboard.jsx - modified file 
...
import { 
  ...
  MessageSquare, Mail, UserPlus, Calendar, Briefcase, Send, Megaphone
} from "lucide-react"
...
const Dashboard = () => {
  ...
  const isActive = (href) => {
    ...
    // ❌ REMOVED: Bulk Call Campaign routes matching
    // if (href === '/dashboard/calls/bulk-campaign' && location.pathname.startsWith('/dashboard/calls/bulk-campaign')) {
    //   return true
    // }
    
    // ✅ Bulk SMS Campaign routes matching
    if (href === '/dashboard/bulk-campaign' && location.pathname.startsWith('/dashboard/bulk-campaign')) {
      return true
    }
    
    // ✅ Calendar routes matching
    if (href === '/dashboard/calendar' && location.pathname.startsWith('/dashboard/calendar')) {
      return true
    }
  ...
  // ✅ UPDATED - CALL NAVIGATION WITHOUT BULK CALL CAMPAIGN
  const callNavigation = [
    { name: 'Call Center', href: '/dashboard/calls/center', icon: PhoneCall },
    // ❌ REMOVED: Bulk Call Campaign item
  ...
  // ✅ COMMUNICATION NAVIGATION WITH BULK SMS CAMPAIGN
  ...
  // ✅ CALENDAR NAVIGATION (Added below Voice Agents)
        ...
        <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
          ...
          {!isAdmin && (
            <>
              ...
              {/* ✅ CALENDAR SECTION (Added below Voice Agents) */}
              <div className="pt-4 pb-2 px-3">
                <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider">
                  Scheduling
                </p>
