...
# from app.services.email_automation import email_automation_service  # ✅ CHANGED: Use email_automation_service
...
#             # ✅ FIXED: Send confirmation email using email_automation_service
#             try:
