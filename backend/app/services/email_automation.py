# # backend/app/services/email_automation.py - UPDATED WITH EMAIL LOGS
...
#         ✅ UPDATED: Now creates entries in email_logs collection
#         """
#         try:
...
#     ) -> None:
#         """
#         ✅ NEW METHOD: Just log the appointment email to email_logs without sending
#         This is used when email is already sent by another service
#         """
#         try:
...
#             # Generate the same email content for logging
#             html_content = f"""
#             <html>
...
# # backend/app/services/email_automation.py - UPDATED WITH EMAIL LOGS AND FIXED get_db without inbound email
...
# # backend/app/services/email_automation.py - UPDATED WITH EMAIL LOGS AND INBOUND EMAIL HANDLING orginal file 
...
#     # ============================================
#     # ✅ NEW METHODS FOR INBOUND EMAIL AI RESPONSE
#     # ============================================
...
#         Args:
#             to_email: Recipient email address
#             subject: Email subject (usually "Re: original_subject")
#             ai_response: AI-generated response text
#             user_id: User ID
#             original_subject: Original email subject
#             ai_source: Source of AI response (openai, campaign, appointment_booking)
...
#             # Update the log entry with AI metadata
#             if result.get("success"):
#                 db = await self.get_db()
                
#                 # Add AI-specific fields to the logged email
...
#         Args:
#             email_address: The email address to get history for
#             user_id: User ID
#             limit: Maximum number of emails to return
        
#         Returns:
#             List of email logs sorted by date
#         """
#         try:
#             db = await self.get_db()
