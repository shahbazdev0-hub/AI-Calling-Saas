...
#                 {f'<p><strong>Phone:</strong> {contact_data.phone}</p>' if contact_data.phone else ''}
#                 {f'<p><strong>Company:</strong> {contact_data.company}</p>' if contact_data.company else ''}
...
#             to_email=settings.EMAIL_FROM,  # Send to your admin email
...
#         <html>
#         <body>
#             <h2>Thank you for contacting CallCenter SaaS!</h2>
...
#                 <p style="white-space: pre-wrap; color: #555;">{contact_data.message}</p>
#             </div>
            
#             <p>
#                 If you need immediate assistance, you can also reach us at:
#                 <br><strong>Email:</strong> {settings.EMAIL_FROM}
#                 <br><strong>Phone:</strong> +1 (555) 123-4567
#             </p>
            
#             <p>Best regards,<br>The CallCenter SaaS Team</p>
#         </body>
#         </html>
#         """

#         user_text_content = f"""
#         Thank you for contacting CallCenter SaaS!
...
#         # Send confirmation to user (optional - comment out if you don't want this)
#         user_email_sent = await email_service.send_email(
#             to_email=contact_data.email,
#             subject="Thank you for contacting CallCenter SaaS",
