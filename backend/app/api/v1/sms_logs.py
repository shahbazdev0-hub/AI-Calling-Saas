# # backend/app/api/v1/sms_logs.py - NEW FILE
...
#         logger.info(f"Reply sent to {reply_request.to_number}")
...
async def reply_to_sms(
    ...
    try:
        ...
        # ✅ FIX: Get the Twilio number from environment
        ...
        if not twilio_phone_number:
            ...
            raise HTTPException(
                status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
                detail="SMS service not configured properly"
            )
